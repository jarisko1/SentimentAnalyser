...
[17:42, 03/11/2024] Peter: Zajtra mozme jaris pokecat
...
[09:49, 04/11/2024] Peter: Jeden topic co zatial nemam sajnu neviete okrem tomiho nejaky tool nacom by sme vedeli nasimulovat mock/demo pre ten sentiment check?
...
if button_input and (text_input or file_input):
    ...
    # st.text(oai.analyze_sentiment(client, text_to_analyze))
